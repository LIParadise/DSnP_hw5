...
silent! normal! zE
let s:l = 602 - ((15 * winheight(0) + 21) / 42)
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 314 - ((28 * winheight(0) + 21) / 42)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
314
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 114 - ((20 * winheight(0) + 21) / 42)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
114
...
wincmd w
argglobal
if bufexists('src/main/adtTest.h') | buffer src/main/adtTest.h | else | edit src/main/adtTest.h | endif
setlocal keymap=
setlocal noarabic
setlocal autoindent
setlocal backupcopy=
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 163 - ((17 * winheight(0) + 10) / 21)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
163
...
wincmd w
argglobal
if bufexists('src/main/adtTest.cpp') | buffer src/main/adtTest.cpp | else | edit src/main/adtTest.cpp | endif
setlocal keymap=
setlocal noarabic
setlocal autoindent
setlocal backupcopy=
